                ...
                <div className="relative flex-1 rounded-xl border border-sidebar-border/70 dark:border-sidebar-border shadow-lg overflow-hidden">
                    ...
                    <div className="p-4 sm:p-6 text-gray-900">
                        ...
                        <div className="bg-white p-4 rounded-lg shadow mb-6">
                            <h2 className="font-semibold text-xl sm:text-2xl text-gray-800 leading-tight mb-4 sm:mb-6 text-center sm:text-left">
                                Daftar Barang Masuk
                            </h2>

                            {/* Filter Form */}
                            <form method="GET" action="/barangMasuk" className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <tbody className="divide-y divide-gray-100 text-gray-700 text-xs sm:text-sm">
                                    {barangMasuk.data.map((item, index) => (
                                        <tr key={item.id} className="hover:bg-gray-50">
                                            <td className="px-4 sm:px-6 py-3">{barangMasuk.from + index}</td>
                        ...
                        <div className="mt-4 flex justify-end">
                            {barangMasuk.total > barangMasuk.per_page && (
